...
module.exports = "<div *ngIf=\"isLoggedIn$ | async as isLoggedIn\">\n  <nav class=\"navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow\">\n\n    <!-- Sidebar Toggle (Topbar) -->\n    <button id=\"sidebarToggleTop\" class=\"btn btn-link d-md-none rounded-circle mr-3\">\n      <i class=\"fa fa-bars\"></i>\n    </button>\n    <ul class=\"navbar-nav ml-auto\">\n\n      <!-- Nav Item - User Information -->\n      <li class=\"nav-item dropdown no-arrow\">\n        <a class=\"nav-link\" href=\"#\" id=\"userDropdown\" aria-expanded=\"false\">\n        </a>\n      </li>\n      <li class=\"nav-item\">\n        <a class=\"nav-link\" href=\"#\" (click)=\"logout()\">\n          <i class=\"fa fa-sign-out-alt fa-sm fa-fw mr-2 text-gray-400\"></i>\n          <span class=\"mr-2 d-none d-lg-inline text-gray-600 small\" (click)=\"onLogout()\" *ngIf=\"isLoggedIn\">Logout</span>\n        </a>\n      </li>\n    </ul>\n\n  </nav>\n</div>"
...
module.exports = "<body class=\"bg-gradient-primary\">\n  <div class=\"container\">\n    <div class=\"row justify-content-center\">\n\n      <div class=\"col-xl-10 col-lg-12 col-md-9\">\n\n        <div class=\"card o-hidden border-0 shadow-lg my-5\">\n          <div class=\"card-body p-0\">\n            <!-- Nested Row within Card Body -->\n\n              <div class=\"row\">\n                <div class=\"col-lg-5 p-5\">\n                  <div class=\"d-none d-lg-block bg-login-image\"></div>\n                </div>\n                <div class=\"col-lg-7\">\n                  <div class=\"p-5\">\n                    <div class=\"text-center\">\n                      <h1 class=\"h2 text-gray-900 mb-4\">Welcome to PicStore</h1>\n                    </div>\n                    <form [formGroup]=\"loginForm\" (ngSubmit)=\"onSubmit()\">\n                      <div class=\"form-error\" *ngIf=\"hasLoginError\">\n                          <span class=\"form-error\">{{loginError}}</span>\n                      </div>\n                      <div *ngIf=\"showError\">Invalid username</div> \n                      <div class=\"form-group\">\n                        <input type=\"text\" class=\"form-control form-control-text\" placeholder=\"Username\" formControlName=\"username\">\n                        <div class=\"field-error\" *ngIf=\"submitted && f.username.errors\">\n                            <div *ngIf=\"f.username.errors.required\">Username is required</div>\n                          </div>\n                      </div>\n                      <div class=\"form-group\">\n                        <input type=\"password\" class=\"form-control form-control-text\" autocomplete=\"off\" placeholder=\"Password\" formControlName=\"password\">\n                        <div class=\"field-error\" *ngIf=\"submitted && f.password.errors\">\n                            <div *ngIf=\"f.password.errors.required\">Password is required</div>\n                          </div>\n                      </div>\n                      <div class=\"form-group\">\n                        <div class=\"custom-control custom-checkbox small\">\n                          <input type=\"checkbox\" class=\"custom-control-input\" id=\"customCheck\">\n                          <label class=\"custom-control-label\" for=\"customCheck\">Remember Me</label>\n                        </div>\n                      </div>\n                      <button type=\"submit\" class=\"btn btn-primary btn-login btn-block\">Login</button>\n                    </form>\n                    <hr>\n                    <div class=\"text-center\">\n                      <a class=\"small\" href=\"forgot-password.html\">Forgot Password?</a>\n                    </div>\n                    <div class=\"text-center\">\n                      <a class=\"small\" href=\"register.html\">Create an Account!</a>\n                    </div>\n                  </div>\n                </div>\n              </div>\n\n          </div>\n        </div>\n      </div>\n    </div>\n  </div>\n</body>"
...
var routes = [
    { path: '', component: _dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_6__["DashboardComponent"], canActivate: [_auth_auth_guard__WEBPACK_IMPORTED_MODULE_5__["AuthGuard"]] },
...
var AppComponent = /** @class */ (function () {
    function AppComponent(sharedService) {
        ...
        this.title = 'picStore';
        this.sharedService.getAllUsers().subscribe(function (data) {
...
var AuthService = /** @class */ (function () {
    function AuthService(router, sharedService) {
        this.router = router;
        this.sharedService = sharedService;
    ...
    AuthService.prototype.login = function (user) {
        ...
        var getUser = this.getUser.find(function (x) { return x.username === user.username && x.password === user.password; });
    ...
    AuthService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])(),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], _services_shared_service__WEBPACK_IMPORTED_MODULE_4__["SharedService"]])
    ], AuthService);
    return AuthService;
}());
...
var URL = /** @class */ (function () {
    ...
    // Local
    URL.authUsersURL = "./assets/json/auth.json";
    URL.usersURL = "./assets/json/users.json";
    URL.revenueURL = "./assets/json/revenue.json";
    URL.uploadedListURL = "./assets/json/uploadedList.json";
    return URL;
}());
...
var DashboardComponent = /** @class */ (function () {
    ...
    DashboardComponent.prototype.getRevenueChartData = function () {
        var _this = this;
        this.sharedService.getRevenueData().subscribe(function (data) {
            _this.revenueData = data.datasets;
            console.log(_this.revenueData);
        });
    };
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(fb, authService, sharedService) {
        this.fb = fb;
        this.authService = authService;
        this.sharedService = sharedService;
    }
    ...
    LoginComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"], _auth_auth_service__WEBPACK_IMPORTED_MODULE_3__["AuthService"], _services_shared_service__WEBPACK_IMPORTED_MODULE_4__["SharedService"]])
    ], LoginComponent);
...
var SharedService = /** @class */ (function () {
    ...
    SharedService.prototype.getAllUsers = function () {
        return this.http.get(_const_url__WEBPACK_IMPORTED_MODULE_4__["URL"].usersURL).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) { return res; }));
    };
    SharedService.prototype.getRevenueData = function () {
        return this.http.get(_const_url__WEBPACK_IMPORTED_MODULE_4__["URL"].revenueURL).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) { return res; }));
    };
    SharedService.prototype.getUploadList = function () {
        return this.http.get(_const_url__WEBPACK_IMPORTED_MODULE_4__["URL"].revenueURL).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) { return res; }));
    };
...
module.exports = __webpack_require__(/*! /home/surangagunawardana/Documents/Gayani/picStore/src/main.ts */"./src/main.ts");
